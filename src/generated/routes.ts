...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { BidController } from './../modules/bids/bids.controller';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
const models: TsoaRoute.Models = {
    ...
    "Product": {
        ...
        "properties": {
            ...
            "current_highest_bid": {"dataType":"double"},
            "bidding_start_time": {"dataType":"datetime","required":true},
            "bidding_end_time": {"dataType":"datetime","required":true},
            "status": {"ref":"ProductStatus","required":true},
            "created_at": {"dataType":"datetime","required":true},
            "updated_at": {"dataType":"datetime","required":true},
            "bids": {"dataType":"array","array":{"dataType":"refObject","ref":"Bid"},"required":true},
        },
    ...
    "User": {
        ...
        "properties": {
            ...
            "wonProducts": {"dataType":"array","array":{"dataType":"refObject","ref":"Product"},"required":true},
            "bids": {"dataType":"array","array":{"dataType":"refObject","ref":"Bid"},"required":true},
        },
        "additionalProperties": false,
    },
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.patch('/api/users/:id/role',
            ...
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.updateRole)),

            async function UserController_updateRole(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsUserController_updateRole, request, response });
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsProductController_getMyProducts: Record<string, TsoaRoute.ParameterSchema> = {
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.get('/api/products/my',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(ProductController)),
            ...(fetchMiddlewares<RequestHandler>(ProductController.prototype.getMyProducts)),

            async function ProductController_getMyProducts(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsProductController_getMyProducts, request, response });
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsManagerController_getPendingProducts: Record<string, TsoaRoute.ParameterSchema> = {
        };
        app.get('/api/manager/products',
            ...
            ...(fetchMiddlewares<RequestHandler>(ManagerController.prototype.getPendingProducts)),

            async function ManagerController_getPendingProducts(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsManagerController_getPendingProducts, request, response });
        ...
        app.get('/api/products/:id/bids',
            ...
            ...(fetchMiddlewares<RequestHandler>(BidController.prototype.getBidHistory)),

            async function BidController_getBidHistory(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsBidController_getBidHistory, request, response });
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsBidController_placeBid: Record<string, TsoaRoute.ParameterSchema> = {
                id: {"in":"path","name":"id","required":true,"dataType":"string"},
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
                body: {"in":"body","name":"body","required":true,"ref":"PlaceBidDto"},
        };
        app.post('/api/products/:id/bids',
            authenticateMiddleware([{"jwt":["user"]}]),
            ...(fetchMiddlewares<RequestHandler>(BidController)),
            ...(fetchMiddlewares<RequestHandler>(BidController.prototype.placeBid)),

            async function BidController_placeBid(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsBidController_placeBid, request, response });
